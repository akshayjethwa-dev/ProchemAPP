...
function DashboardStackNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="AdminNegotiations" component={NegotiationsListScreen} options={{ headerShown: true, title: 'Monitor Negotiations' }} />
      <Stack.Screen name="NegotiationRoom" component={NegotiationRoomScreen} options={{ headerShown: true, title: 'Price Discussion' }} />
      <Stack.Screen name="AdminBroadcastBids" component={AdminBroadcastBidsScreen} options={{ headerShown: true, title: 'Supplier Bids', headerBackTitle: 'Back' }} />
      <Stack.Screen name="AdminWhatsAppLogs" component={AdminWhatsAppLogsScreen} options={{ headerShown: true, title: 'WhatsApp Logs', headerBackTitle: 'Back' }} />
